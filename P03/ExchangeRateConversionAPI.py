...
class ExchangeRateConversionAPI:
    ...
    def __init__(self, params: dict) -> None:
        ...
        self.url = ExchangeRateConversionAPI.API_URL.format(API_KEY=ExchangeRateConversionAPI.API_KEY, base=params['base'], to=params['to'])
    ...
    def fetch_from_amount(self, amount: float) -> json:
        ...
        self.conversion_rate = resp['conversion_rate']
        self.conversion_result = resp['conversion_result']
    ...
    def get_conversion_result(self) -> str:
        return format(self.conversion_result, '.2f')
...
if __name__ == '__main__':
    ...
    while True:
        ...
        api = ExchangeRateConversionAPI({'base': base, 'to': to})
        ...
        print(output.format(base_amount=format(amount, '.2f'), base_code=api.get_base_code(), conversion_result=api.get_conversion_result(), target_code=api.get_target_code(), conversion_rate=api.get_conversion_rate()))
